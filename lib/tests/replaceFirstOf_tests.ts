import { replaceFirstOf } from '../privy/replaceFirstOf';
...
if (arraysMatch(arr, [1, 20, 3, 1, 2, 3, 1, 2, 3, '1', '2', '3'])) console.log('test 1 passed');
...
replaceFirstOf('a', 'z', arr);
if (arraysMatch(arr, ['aa', 'z', 'aa', 'a', 'aa', 'a', 'aa', 'a', 10, 'aa', 1]))
...
arrCopy = arr;
replaceFirstOf(false, 'no', arr);
if (arraysMatch(arr, [true, 'no', true, false, 1, 0, 1, undefined])) console.log('test 4 passed');
...
arrCopy = arr;
replaceFirstOf(['bb'], [], arr);
if (arraysMatch(arr, ['bb', [], ['b'], 'bb', ['bb'], ['b'], 'bb'])) console.log('test 5 passed');
...
// Test 6:
arr = ['', '0', '', '0', '', '0'];
replaceFirstOf('', 0, arr);
if (arraysMatch(arr, [0, '0', '', '0', '', '0'])) console.log('test 6 passed');
else console.log('test 6 FAILED');


// Test 7:
arr = ['', 0, '', 0, '', 0];
replaceFirstOf('', 1, arr);
...
arr = ['bb', ['bb'], ['b'], 'bb', ['bb'], ['b'], 'bb'];
replaceFirstOf(['b'], {prop1: 'b'}, arr);
if (arr[2].prop1 && arr[2].prop1 === 'b') console.log('test 8 passed');
